...
- [3. Projeto / Laboratório](#3-projeto--laboratório)
  ...
  * [3.3. Guia de Implantação, Configuração e Instalação](#33-guia-de-implantação-configuração-e-instalação)
    ...
    + [3.3.4. Create/Configure AWS credential access key on AWS CLI](#334-createconfigure-aws-credential-access-key-on-aws-cli)
...
* **Passo 1**: Criar AWS Credential Access Key
  ...
  * Em `AWS :: Security, Identity & Compliance >> IAM` clique `Manage access key`
